    ...
    return (
        <div className="modal-overlay-menu">
            <div className="modal-content-menu">
                <button className="modal-close-menu" onClick={onClose}>
                    ×
                </button>
                ...
                <div className="type-switcher-menu">
                    <button
                        className={
                            type === 'dish'
                                ? 'button-modal-journal-menu active'
                                : 'button-modal-journal-menu'
                        }
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="modal-submit-menu">
                        Додати
                    </button>
                </form>
